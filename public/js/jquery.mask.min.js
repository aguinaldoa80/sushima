...
var $jscomp = {
    scope: {}, findInternal: function (a, f, c) {
...
(function (a, f, c) {
    ...
    var f = function (b, h, e) {
        var d = {
            invalid: [], getCaret: function () {
                try {
                    var a, n = 0, h = b.get(0), e = document.selection, k = h.selectionStart;
                ...
                for (var a = [], b, d, e, k,
                         c = 0; c < h.length; c++)(b = m.translation[h.charAt(c)]) ? (d = b.pattern.toString().replace(/.{1}$|^.{1}/g, ""), e = b.optional, (b = b.recursive) ? (a.push(h.charAt(c)), k = {
                    digit: h.charAt(c),
                    pattern: d
                }) :
                ...
                var h =
                    d.length, e = b.data("mask-previus-value") || "", k = e.length;
                ...
                if (-1 === a.inArray(h, m.byPassKeys)) {
                    var h = d.getMasked(), c = d.getCaret();
                ...
                var c =
                        [], p = void 0 === b ? d.val() : b + "", k = 0, g = h.length, f = 0, l = p.length, n = 1,
                    v = "push", w = -1, r, u;
                ...
                for (var y; u();) {
                    var x = h.charAt(k), t = p.charAt(f), q = m.translation[x];
                ...
                var f = d.val(), p = f !== c, g = [f, a, b, e], k = function (a, b, d) {
    ...
    a.fn.mask = function (b, c) {
        c = c || {};
        var e = this.selector, d = a.jMaskGlobals, h = d.watchInterval, d = c.watchInputs || d.watchInputs,
            g = function () {
                if (l(this, b,
